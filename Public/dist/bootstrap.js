        ...
        _c(
          ...
          [
            _c(
              ...
              {
                staticClass:
                  "flex text-white animate-pulse flex-col justify-center items-center text-6xl",
                attrs: { id: "counter" }
              },
              [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "px-4 w-full md:w-1/2 lg:w-1/3" }, [
      _c("h1", { staticClass: "text-2xl" }, [_vm._v("History")]),
      _vm._v(" "),
      _c("div", { staticClass: "rounded shadow bg-white my-3" }, [
        _c(
          "div",
          { staticClass: "flex flex-col p-2 border-b border-gray-300" },
          [
            _c("h3", { staticClass: "font-semibold text-gray-800" }, [
              _vm._v("Yesterday — 07:50am - 03:20pm")
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "text-gray-600" }, [_vm._v("Working")])
          ]
        ),
        _vm._v(" "),
        _c(
